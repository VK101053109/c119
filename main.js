...
function classifyCanvas() {
    classifier.classify(canvas, gotr);
}
...
function gotr(e, r) {
    if (e) {
        ...
        console.log(r);
        document.getElementById("s_name").innerHTML = "sketch:" + r[0].label;
        document.getElementById("c_sketch").innerHTML = "Confidence: " + Math.round(r[0].confidence * 100) + "%";
